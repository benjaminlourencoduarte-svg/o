warn("THIS HUB HAS BUGS you can break and somentimes you die then cant spawn at another ant team and need to rejoin")
...
main_A:Button("anti kick", function()
	while wait(0.5) do
		local lp = game.Players.LocalPlayer
		setreadonly(lp, false)
		local k = lp.Kick
		local d = lp.Destroy
		k = function() print("anti kick") end
		d = function() print("anti destroy") end
	end
end)
--[[
more tash
